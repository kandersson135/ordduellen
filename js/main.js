$(document).ready(function() {
  ...
  */
  ...
  $('#how-to-btn').click(function() {
    swal("Hur du spelar", "Spela det roliga ordkombinationsspelet! Utmana dina vänner att kombinera ord med varandra genom att börja varje ord med den sista bokstaven i det föregående ordet. Samla poäng genom att skriva in ord, och se vem som når " + winningScore + " poäng först för att vinna spelet!");
  });
